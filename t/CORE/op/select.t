...
open my $fh, $test_pl or die "$0 unfortunately cannot open test.pl: $!";
...
open foo::bar, $test_pl or die "$0 sadly cannot open test.pl: $!";
select foo::bar;
$handle = \*foo::bar;
$stash = \%foo::;
*foo:: = *bar::;
...
open thwat::snin, $test_pl or die "$0 is unable to open test.pl: $!";
select thwat::snin;
$handle = \*thwat::snin;
